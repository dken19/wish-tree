...
Trang chủ là **cây 3D treo điều ước (giấy đỏ)**, có gió + thời tiết Hà Nội, đồng cỏ/bướm/chuồn chuồn/sương, bàn thư pháp để viết điều ước, hoạ tiết chim Lạc. Người dùng gửi điều ước → lọc từ + duyệt tay → hiện realtime trên cây. Có **menu dock** (góc dưới-phải, `NavDock`) chuyển nhanh: Cây · Viết · Phòng ôn bài (đổi state, giữ 1 Canvas) · **Kỹ năng sống** (route `/ky-nang`, dữ liệu `lib/skills.ts`) — 4 nhóm: nấu nướng/trồng trọt/chụp ảnh/chăm sóc da, mỗi bài có ảnh (Wikimedia Commons, hotlink `<img>` thường) + nguồn Wikipedia; KHÔNG mount Canvas.
